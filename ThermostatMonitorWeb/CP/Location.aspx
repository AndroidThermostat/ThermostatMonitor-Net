<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ControlPanel.master" AutoEventWireup="true" CodeFile="Location.aspx.cs" Inherits="cp_Location" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <form id="Form1" runat="server">
        ...
        <table>
            ...
            <tr><td>Zip Code</td><td><asp:TextBox ID="ZipCodeText" runat="server" /></td></tr>
            <tr><td>Electricity Price</td><td><asp:TextBox ID="PriceText" runat="server" Text="10.00"/> in <u>cents</u> per kilowatt hour</td></tr>
            <tr><td>Heat Fuel Price</td><td><asp:TextBox ID="HeatPriceText" runat="server" Text="10.00"/> in <u>dollars</u> per Dekatherm (1 Dekatherm = 1,000,000 BTU)</td></tr>
            ...
            <asp:DropDownList ID="TimezoneList" runat="server">
                ...
                <tr><td colspan="2"><asp:CheckBox ID="ShareCheck" runat="server" />May we share your anonymous thermostat data with others? *</td></tr>
            <tr><td colspan="2" align="center"><asp:Button ID="SaveButton" runat="server" Text="Save" onclick="SaveButton_Click" /></td></tr>
        </table>
